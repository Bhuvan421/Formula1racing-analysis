...
merge_condition = "targetTable.race_id = sourceTable.race_id AND targetTable.driver_id = sourceTable.driver_id AND targetTable.lap = SourceTable.lap AND targetTable.race_id = sourceTable.race_id"
merge_delta_data(laps_df, 'f1_processed', 'lap_times_cleaned', processed_folder, merge_condition, 'race_id')
