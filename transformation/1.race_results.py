...
drivers_df = spark.read.parquet(f'{processed_folder}/drivers_cleaned')
drivers_df.printSchema()

# COMMAND ----------

constructors_df = spark.read.parquet(f'{processed_folder}/constructors_cleaned')
constructors_df.printSchema()

# COMMAND ----------

circuits_df = spark.read.parquet(f'{processed_folder}/circuits_cleaned')
circuits_df.printSchema()

# COMMAND ----------

races_df = spark.read.parquet(f'{processed_folder}/races_cleaned')
races_df.printSchema()

# COMMAND ----------

results_df = spark.read.parquet(f'{processed_folder}/results_cleaned')
