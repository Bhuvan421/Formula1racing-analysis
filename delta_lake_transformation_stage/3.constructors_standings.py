...
merge_condition = "targetTable.team = sourceTable.team AND targetTable.race_year = sourceTable.race_year"
merge_delta_data(final_df, 'f1_presentation', 'constructors_standings', presentation_folder, merge_condition, 'race_year')
